...
int MyMessage_Base::getNodeId() const
{
    return this->NodeId;
}

void MyMessage_Base::setNodeId(int NodeId)
{
    this->NodeId = NodeId;
}
...
char MyMessage_Base::getMycheckbits() const
{
    return this->mycheckbits;
}

void MyMessage_Base::setMycheckbits(char mycheckbits)
{
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "NodeId") == 0) return baseIndex + 3;
    if (strcmp(fieldName, "M_Payload") == 0) return baseIndex + 4;
    if (strcmp(fieldName, "mycheckbits") == 0) return baseIndex + 5;
